...
- <code><a href="./src/resources/beta/assistants/assistants.ts">AssitantDeleted</a></code>
...
- <code title="delete /assistants/{assistant_id}">client.beta.assistants.<a href="./src/resources/beta/assistants/assistants.ts">del</a>(assistantId) -> AssitantDeleted</code>
