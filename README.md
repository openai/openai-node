...
> ⚠️ **Note:** All log messages are intended for debugging only. The format and content of log messages
...
At the `'debug'` level, all HTTP requests and responses are logged, including headers and bodies. This may
include sensitive information like authentication tokens.
