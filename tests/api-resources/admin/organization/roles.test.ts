...
describe('resource roles', () => {
  test('create: only required params', async () => {
    const responsePromise = client.admin.organization.roles.create({
      permissions: ['string'],
      role_name: 'role_name',
    });
  ...
  test('list', async () => {
    const responsePromise = client.admin.organization.roles.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete', async () => {
    const responsePromise = client.admin.organization.roles.delete('role_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
