...
export namespace CreateEvalCompletionsRunDataSource {
  ...
  export interface Template {
     ...
     */
    template: Array<ResponsesAPI.EasyInputMessage | Shared.EvalItem>;
...
export interface CreateEvalResponsesRunDataSource {
   ...
   */
  source: EvalJSONLFileContentSource | EvalJSONLFileIDSource | CreateEvalResponsesRunDataSource.Responses;
