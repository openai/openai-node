...
type WebSocketErrorEvent = Extract<ResponsesAPI.BetaResponsesServerEvent, { type: 'error' }>;
...
type WebSocketEvents = Simplify<
  {
    ...
    [EventType in Exclude<NonNullable<ResponsesAPI.BetaResponsesServerEvent['type']>, 'error'>]: (
      event: Extract<ResponsesAPI.BetaResponsesServerEvent, { type?: EventType }>,
    ) => unknown;
  }
>;
