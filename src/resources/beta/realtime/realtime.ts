...
import type * as RealtimeAPI from './realtime';
import type * as Shared from '../../shared';
import * as SessionsAPI from './sessions';
import type { Session as SessionsAPISession, SessionCreateParams, SessionCreateResponse } from './sessions';
import { Sessions } from './sessions';
import * as TranscriptionSessionsAPI from './transcription-sessions';
import type { TranscriptionSession, TranscriptionSessionCreateParams } from './transcription-sessions';
...
export interface ConversationItemInputAudioTranscriptionCompletedEvent {
   ...
   */
  logprobs?: ConversationItemInputAudioTranscriptionCompletedEvent.Logprob[] | null;
}
...
export interface ConversationItemInputAudioTranscriptionDeltaEvent {
   ...
   * The log probabilities of the transcription.
   */
  logprobs?: ConversationItemInputAudioTranscriptionDeltaEvent.Logprob[] | null;
}
...
export interface ConversationItemWithReference {
   ...
   * - Message items of role `assistant` support `text` content.
   */
  content?: ConversationItemWithReference.Content[];
...
export interface RateLimitsUpdatedEvent {
   ...
   */
  rate_limits: RateLimitsUpdatedEvent.RateLimit[];
...
export namespace ResponseCreateEvent {
  ...
  export interface Response {
     ...
     */
    input?: RealtimeAPI.ConversationItemWithReference[];
