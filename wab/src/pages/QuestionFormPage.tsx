    ...
    <div className="min-h-screen bg-[#F3F4F6] font-sans flex flex-col">
      ...
      <div className="h-16 bg-white border-b border-gray-200 px-6 flex items-center justify-between flex-shrink-0 sticky top-16 z-40">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-bold text-gray-900">新问题</h1>
        </div>
        <button
          onClick={onBack}
          className="px-6 py-2 bg-[#6B7280] hover:bg-[#4B5563] text-white font-medium rounded text-sm transition-colors">
      ...
      <main className="flex-1 overflow-y-auto py-8 px-4">
        <div className="max-w-[800px] mx-auto bg-white rounded-lg shadow-sm p-10 md:p-12">
          ...
          {/* Section 1: Question */}
          <div className="mb-10">
            <h3 className="text-lg font-bold text-gray-900 mb-6">1.问题</h3>
            ...
            <div className="mb-6 relative">
              <div className="relative">
                <select
                  ...
                  <option value="visa">签证问题</option>
                  <option value="passport">护照问题</option>
